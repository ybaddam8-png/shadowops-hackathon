...
| Policy | exact_match | safety_accuracy | unsafe_decision_rate | false_positive_rate | reward_mean |
| --- | ---: | ---: | ---: | ---: | ---: |
| random | 0.265 | 0.690 | 0.310 | 0.263 | -0.060 |
| heuristic | 0.600 | 0.700 | 0.300 | 0.250 | 1.118 |
| q_aware | 1.000 | 1.000 | 0.000 | 0.000 | 1.911 |
| oracle | 1.000 | 1.000 | 0.000 | 0.000 | 2.091 |
...
- Hidden scenario file: `training\hidden_eval_scenarios.json`
